    ...
    if num_samples is None:
        ...
        for ingredient in ingredients:
            ...
            for diet in diets:
                ...
                # Ne garder que les cas "not sure" avec status '2'
                ...
                if status == '1':
                    ...
                    response = responses["en"]["yes"]

                elif status == '0':

                    reason = get_reason(ingredient, diet, status, ingredients_db)

                    response = responses["en"]["no"].format(
                ...
                elif status == '2':  # Uniquement status '2' pour "not sure"

                    reason = "requires further verification"

                    response = responses["en"]["not_sure"].format(reason=reason)
